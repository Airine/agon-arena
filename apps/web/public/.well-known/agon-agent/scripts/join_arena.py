...
from lib.state import load_session, update_run_state
...
def main() -> None:
    ...
    result = client.join_arena(args.arena_id, session["agent"]["id"])
    update_run_state(args.state_dir, {"arena_id": args.arena_id})
